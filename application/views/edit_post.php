 ...
 <div class="container">
   ...
   <div class="row">
     ...
     <div class="col-md-2 sideBar">
       ...
       <hr>
       <i class="fas fa-caret-left"></i> <?php echo anchor('dashboard', 'ADD NEW POST') ?>
       <hr>
     </div>
     <div class="col-md-9 columns pt">
       <h4 class="text-center animated bounceIn">UPDATE POST</h4>
       ...
       echo form_open_multipart("dashboard/update_post/{$post['post_id']}", ['class'=>'form-horizontal']); ?>

          <div class="col-md-12 divInputs form-group">
            <label>Title</label>
            <?php
              echo form_input(['name'=>'post_title', 'placeholder'=>'Title', 'class'=>'form-control inputs', 'value'=>set_value('post_title', $post['post_title']) ]);
          ...
          <div class="col-md-12 divInputs form-group">
            ...
            <?php
              echo form_textarea(['name'=>'post_description', 'placeholder'=>'Description', 'class'=>'form-control', 'value'=>set_value('post_description', $post['post_description']) ]);
          ...
          <div class="col-md-12 divInputs form-group">
            <?php echo form_submit(['name'=>'submit', 'value'=>'UPDATE POST', 'class'=>'btn buttons']) ?>
          </div>
